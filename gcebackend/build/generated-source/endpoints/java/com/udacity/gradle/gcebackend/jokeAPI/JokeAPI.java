 ...
 * on 2015-11-28 at 19:43:41 UTC 
 * Modify at your own risk.
 */

package com.udacity.gradle.gcebackend.jokeAPI;
...
public class JokeAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-it-bigger-1143.appspot.com/_ah/api/";
  ...
  /**
   * An accessor for creating requests from the JokeAPIOperations collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code JokeAPI jokeAPI = new JokeAPI(...);}
   *   {@code JokeAPI.JokeAPIOperations.List request = jokeAPI.jokeAPI().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public JokeAPIOperations jokeAPI() {
    return new JokeAPIOperations();
  }

  /**
   * The "jokeAPI" collection of methods.
   */
  public class JokeAPIOperations {

    /**
     * Create a request for the method "jokeAPI.loadJoke".
     *
     * This request holds the parameters needed by the jokeAPI server.  After setting any optional
     * parameters, call the {@link LoadJoke#execute()} method to invoke the remote operation.
     *
     * @return the request
     */
    public LoadJoke loadJoke() throws java.io.IOException {
      LoadJoke result = new LoadJoke();
      initialize(result);
      return result;
    }

    public class LoadJoke extends JokeAPIRequest<com.udacity.gradle.gcebackend.jokeAPI.model.MyBean> {

      private static final String REST_PATH = "jokeAPI";

      /**
       * Create a request for the method "jokeAPI.loadJoke".
       *
       * This request holds the parameters needed by the the jokeAPI server.  After setting any optional
       * parameters, call the {@link LoadJoke#execute()} method to invoke the remote operation. <p>
       * {@link
       * LoadJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @since 1.13
       */
      protected LoadJoke() {
        super(JokeAPI.this, "POST", REST_PATH, null, com.udacity.gradle.gcebackend.jokeAPI.model.MyBean.class);
      }

      @Override
      public LoadJoke setAlt(java.lang.String alt) {
        return (LoadJoke) super.setAlt(alt);
      }

      @Override
      public LoadJoke setFields(java.lang.String fields) {
        return (LoadJoke) super.setFields(fields);
      }

      @Override
      public LoadJoke setKey(java.lang.String key) {
        return (LoadJoke) super.setKey(key);
      }

      @Override
      public LoadJoke setOauthToken(java.lang.String oauthToken) {
        return (LoadJoke) super.setOauthToken(oauthToken);
      }

      @Override
      public LoadJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (LoadJoke) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public LoadJoke setQuotaUser(java.lang.String quotaUser) {
        return (LoadJoke) super.setQuotaUser(quotaUser);
      }

      @Override
      public LoadJoke setUserIp(java.lang.String userIp) {
        return (LoadJoke) super.setUserIp(userIp);
      }

      @Override
      public LoadJoke set(String parameterName, Object value) {
        return (LoadJoke) super.set(parameterName, value);
      }
    }
  ...
  public class SayHi extends JokeAPIRequest<com.udacity.gradle.gcebackend.jokeAPI.model.MyBean> {
