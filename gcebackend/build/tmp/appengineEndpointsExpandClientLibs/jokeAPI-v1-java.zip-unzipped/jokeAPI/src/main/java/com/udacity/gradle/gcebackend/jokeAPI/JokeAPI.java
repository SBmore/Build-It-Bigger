...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *   {@code JokeApi.MyEndpoint.List request = jokeApi.myEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  public class MyEndpoint {
    ...
    /**
     * Create a request for the method "myEndpoint.loadJoke".
     *
    ...
    public class LoadJoke extends JokeApiRequest<com.udacity.gradle.gcebackend.jokeApi.model.MyBean> {
      ...
      private static final String REST_PATH = "loadJoke";
